...
public class Pikachu extends Creature
{
    ...
    public void attack(int idx)
    {
        ...
        else
        {
            ...
            if( enemyType.equalsIgnoreCase("Rock"))
            {
                ...
                /**
                 * TODO (112): Show text that states the attack has no effect at an x location of half the width of the world 
                 *          and a y location of half the height of the world plus 26 pixels
                 */
                getWorld().showText("The attack got goofed...", getWorld().getWidth()/2, getWorld().getHeight()/2);
            ...
            if( enemyType.equalsIgnoreCase("Grass"))
            {
                 ...
                 *          and a y location of half the height of the world plus 26 pixels
                 */
                getWorld().showText("The attack was not very efective...", getWorld().getWidth()/2, getWorld().getHeight()/2);
     ...
     *          initialized to get a new player two creature using the idx parameter
     *          
    ...
    public void switchCreature(int idx)
    {
        ...
        {
            JOptionPane.showInputDialog(null, "OHH MA GAD HE DEAD!");
        }
