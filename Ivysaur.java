    ...
    public void attack(int idx)
    {
        ...
        else
        {
            ...
            if(enemyType.equalsIgnoreCase("Electric"))
            {
                 ...
                 */
                getWorld().showText("That attack was weaksauce...", getWorld().getWidth()/2, getWorld().getHeight()/2+26);
            ...
            else if(enemyType.equalsIgnoreCase("Water"))
            {
                ...
                getWorld().showText("that attack was pretty dank, so double damage for you!", getWorld().getWidth()/2, getWorld().getHeight()/2+26);
