...
public class Charmander extends Creature
{
    ...
    public void switchCreatures(int idx)
    {
        ...
        {
            JOptionPane.showMessageDialog(null, "The Creature you have attempted to switch to is DEAD. I would say use a revive but thats nt a thing. Chose a different creature");
        }
        else
        {
            while(getX() >= 0)
